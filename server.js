...
//
// Local development:
//   Uses PORT from .env or defaults to 5003.
//
// Render deployment:
...
// -----------------------------------------------------------------------------
//
// We serve everything from /public as static assets.
// index.html, styles.css, app.js, and assets live in /public.
//
...
io.on("connection", (socket) => {
  ...
  // --- Optional explicit governance submission (not used by current app.js,
  //     but kept for compatibility if you ever wire it back up)
...
// -----------------------------------------------------------------------------
// Turbo Workflow (ultra-fast demo path)
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// OpenAI Helper (using fetch, no SDK dependency)
// -----------------------------------------------------------------------------
